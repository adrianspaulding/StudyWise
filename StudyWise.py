...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Set as central widget and display
    ...
    # Updates which screen is showing
    ...
    # Adds Wrapped Text for button labels
    ...
    # Handles Button clicking and question grabbing
